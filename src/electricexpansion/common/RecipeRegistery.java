...
public class RecipeRegistery
{
	...
	public static void crafting()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(blockBatBox), new Object[] { "!!!", "@@@", "!#!", '!', new ItemStack(BasicComponents.itemBattery, 1, Integer.MIN_VALUE), '@', "copperWire", '#', "basicCircuit" }));
	...
	public static void insulation()
	{
		...
		GameRegistry.addShapelessRecipe(insulationIS, Block.cloth, Block.cloth, Block.cloth, Block.cloth);
