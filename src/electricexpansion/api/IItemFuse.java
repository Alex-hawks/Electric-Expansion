...
public interface IItemFuse
{
	 ...
	 * @return
	 * 			The maximum amperage. If the amperage is above this, {@link IItemFuse#onFuseTrip} will be called.
	 ...
	 * @param itemStack	The ItemStack, to provide the metadata to the method.
	 * @return 
	 * 			true if there should be a reset button in the GUI of the Fuse Box.
	 * </br>	If true, clicking the "Reset" button will call {@link IItemFuse#onReset}
	 */
