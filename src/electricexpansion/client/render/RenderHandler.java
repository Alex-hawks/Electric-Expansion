...
public class RenderHandler implements ISimpleBlockRenderingHandler
{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer)
	{
		...
		if (block.blockID == ElectricExpansion.blockTransformer.blockID)
		{
			switch (metadata / 4)
			{
				case 0:	GL11.glBindTexture(3553, FMLClientHandler.instance().getClient().renderEngine.getTexture(ElectricExpansion.MODEL_PATH + "transformer1.png"));
						break;
				case 1:	GL11.glBindTexture(3553, FMLClientHandler.instance().getClient().renderEngine.getTexture(ElectricExpansion.MODEL_PATH + "transformer2.png"));
						break;
				case 2:	GL11.glBindTexture(3553, FMLClientHandler.instance().getClient().renderEngine.getTexture(ElectricExpansion.MODEL_PATH + "transformer3.png"));
						break;
			}
			GL11.glRotatef(180, 0.0F, 1.0F, 0.0F);
			GL11.glTranslatef(0.5F, .8F, 0.5F);
