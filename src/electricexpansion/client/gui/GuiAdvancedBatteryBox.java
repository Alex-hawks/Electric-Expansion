...
public class GuiAdvancedBatteryBox extends GuiContainer
{
    ...
    public GuiAdvancedBatteryBox(InventoryPlayer par1InventoryPlayer,
    ...
    {
        this.fontRenderer.drawString(this.tileEntity.getInvName(), 22, 6,
                4210752);
        ...
        String displayMaxJoules = ElectricityDisplay.getDisplayShort(
                this.tileEntity.getMaxJoules(), ElectricUnit.JOULES);
        String displayInputVoltage = ElectricityDisplay.getDisplayShort(
                this.tileEntity.getInputVoltage(), ElectricUnit.VOLTAGE);
        String displayOutputVoltage = ElectricityDisplay.getDisplayShort(
                this.tileEntity.getVoltage(), ElectricUnit.VOLTAGE);
        ...
        this.fontRenderer.drawString(displayJoules + " of",
                73 - displayJoules.length(), 25, 4210752);
        this.fontRenderer.drawString(displayMaxJoules, 70, 35, 4210752);
        this.fontRenderer.drawString("Voltage: " + displayOutputVoltage, 65,
                55, 4210752);
        this.fontRenderer.drawString("Input: " + displayInputVoltage, 65, 65,
                4210752);
            ...
            int par3)
    {
        ...
        int scale = (int) (this.tileEntity.getJoules()
                / this.tileEntity.getMaxJoules() * 72.0D);
