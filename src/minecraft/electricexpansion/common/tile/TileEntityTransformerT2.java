...
public class TileEntityTransformerT2 extends TileEntityElectricityReceiver implements IRotatable, IPacketReceiver
{
	...
	{
		ElectricityConnections.registerConnector(this, EnumSet.of(ForgeDirection.getOrientation(this.getBlockMetadata() - BlockTransformer.TIER_2_META + 2), ForgeDirection.getOrientation(this.getBlockMetadata() - BlockTransformer.TIER_2_META + 2).getOpposite()));
	...
	public void updateEntity()
	{
		...
		if (this.ticks % 20 == 0)
		{
			...
			{
				ForgeDirection inputDirection = ForgeDirection.getOrientation(this.getBlockMetadata() - BlockTransformer.TIER_2_META + 2).getOpposite();
				TileEntity inputTile = Vector3.getTileEntityFromSide(this.worldObj, new Vector3(this), inputDirection);

				// Check if requesting power on output
				ForgeDirection outputDirection = ForgeDirection.getOrientation(this.getBlockMetadata() - BlockTransformer.TIER_2_META + 2);
	...
	{
		return ForgeDirection.getOrientation(this.getBlockMetadata() - BlockTransformer.TIER_2_META);
	}
