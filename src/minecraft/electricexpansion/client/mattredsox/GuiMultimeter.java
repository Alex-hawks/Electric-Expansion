...
public class GuiMultimeter extends GuiContainer
{
   ...
   PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ElectricExpansion.CHANNEL, this.tileEntity, (int) -1, true));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        if(tileEntity.elecPack != null)
        this.fontRenderer.drawString(ElectricInfo.getDisplay(tileEntity.elecPack.voltage, ElectricUnit.VOLTAGE), (this.width - (this.xSize - 180)) / 2, (this.height - (this.ySize - 80)) / 2, 0xFFFFFF);
