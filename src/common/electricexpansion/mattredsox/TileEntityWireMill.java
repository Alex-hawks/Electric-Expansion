...
public class TileEntityWireMill extends TileEntityElectricityReceiver implements IInventory, ISidedInventory,  IPacketReceiver
{
    ...
    */
    ...
    {
        if (WireMillRecipes.smelting().getSmeltingResult(this.containingItems[1]) == null)
        {
            return false;
        }
        ...
        {
            if (!this.containingItems[2].isItemEqual(WireMillRecipes.smelting().getSmeltingResult(this.containingItems[1])))
            {
                return false;
            }
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ItemStack resultItemStack = WireMillRecipes.smelting().getSmeltingResult(this.containingItems[1]);
