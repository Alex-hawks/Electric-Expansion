...
public class BlockMattMachine extends BlockMachine
{
	public static final int UP_Trans_meta = 0;
	public static final int DOWN_Trans_meta = 4;
	public static final int Volt_det_meta = 8;

	public BlockMattMachine(int id, int textureIndex)
	{
		super("mattMachine", id, UniversalElectricity.machine, UETab.INSTANCE);
	...
	*//**
	...
	public void onBlockPlacedBy(World par1World, int x, int y, int z, EntityLiving par5EntityLiving)
	{
		...
		if (metadata >= DOWN_Trans_meta)
		{
			switch (angle)
			{
				case 0:
					par1World.setBlockMetadataWithNotify(x, y, z, DOWN_Trans_meta + 1);
					break;
				case 1:
					par1World.setBlockMetadataWithNotify(x, y, z, DOWN_Trans_meta + 2);
					break;
				case 2:
					par1World.setBlockMetadataWithNotify(x, y, z, DOWN_Trans_meta + 0);
					break;
				case 3:
					par1World.setBlockMetadataWithNotify(x, y, z, DOWN_Trans_meta + 3);
					break;
			}
		}
		else if (metadata >= BATTERY_BOX_METADATA)
	...
	*//**
	...
	{
		return new ItemStack(this.blockID, 1, DOWN_Trans_meta);
	}
