...
import electricexpansion.mattredsox.tileentities.TileEntityBCBatteryBox;
...
public class BlockBCBatteryBox extends BlockMachine
{
	public static final int BATTERY_BOX_METADATA = 0;	
    public BlockBCBatteryBox(int id, int textureIndex)
    {
   ...
   /* @Override
	...
	{
			return new TileEntityBCBatteryBox();
	}
