...
public class ContainerTransformer extends Container
{
    ...
    public ContainerTransformer(InventoryPlayer par1InventoryPlayer, TileEntityTransformer Transformer)
    {
        ...
        this.addSlotToContainer(new SlotTransformerCoil(Transformer, 0, 11, 24)); //Top slot
        this.addSlotToContainer(new SlotTransformerCoil(Transformer, 1, 11, 48)); //Bottom slot
