...
{	
	...
	public static void crafting()
	{
		...
		{
			//Lead-Tear Battery				
			GameRegistry.addRecipe(new ItemStack(itemEliteBatBat), new Object [] {"!@!", "#$#", "!@!", '!', BasicComponents.itemSteelPlate, '@', new ItemStack(blockInsulatedWire, 1, 0), '#', ElectricExpansion.itemLead, '$', Item.ghastTear});
