...
{	
	...
	public static void crafting()
	{
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(blockRawWire, 12, 4), new Object [] {" @ ", " @ ", " @ ", '@', "ingotEndium"}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockInsulatedWire, 1, 4), new Object[]{new ItemStack(blockRawWire, 1, 4), Block.cloth}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(blockInsulatedWire, 12, 4), new Object [] {"#@#", "#@#", "#@#", '#', Block.cloth, '@', "ingotEndium"}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockWireBlock, 1, 4), new Object[]{new ItemStack(blockRawWire, 1, 4), Block.cloth, Block.stone}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockWireBlock, 1, 4), new Object[]{new ItemStack(blockInsulatedWire, 1, 4), Block.stone}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockSwitchWireOff, 1, 4), new Object[]{new ItemStack(blockRawWire, 1, 4), Block.cloth, Block.lever}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockSwitchWireOff, 1, 4), new Object[]{new ItemStack(blockInsulatedWire, 1, 4), Block.lever}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockSwitchWireBlockOff, 1, 4), new Object[]{new ItemStack(blockRawWire, 1, 4), Block.cloth, Block.stone, Block.lever}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockSwitchWireBlockOff, 1, 4), new Object[]{new ItemStack(blockInsulatedWire, 1, 4), Block.stone, Block.lever}));
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(blockSwitchWireBlockOff, 1, 4), new Object[]{new ItemStack(blockWireBlock, 1, 4), Block.lever}));
